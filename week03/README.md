PM 566 Lab 3 - Chris Hanson
================

The purpose of PM566 lab 3 is to investigate the meteorological data
provided by the National Center for Environmental Information, which is
hourly measurements from weather stations across the USA. The objective
is to find the weather station with the highest elevation and
investigate its wind speed and temperature.
...
```
    ...
    ##       lat      lon wind.sp temp elev
    ## 1: 44.683 -111.116       0 -3.0 2025
    ## 2: 44.683 -111.116       0 -3.0 2025
    ## 3: 44.683 -111.116       0 -3.0 2025
    ## 4: 44.683 -111.116       0 -3.0 2025
    ## 5: 36.422 -105.290       0 -2.4 2554
    ## 6: 44.683 -111.116       0 -2.0 2025
